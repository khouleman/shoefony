...
class Product
{
     ...
     * @ORM\JoinTable(
     *     name="sto_product_color",
     *     joinColumns={
     *         @ORM\JoinColumn(name="sto_product_id", nullable=false)
     *     },
     *     inverseJoinColumns={
     *         @ORM\JoinColumn(name="sto_color_id", nullable=false)
     *     },
     * )
     */
    private $colors;
    ...
    /**
     * @ORM\OneToMany(targetEntity="App\Entity\Store\Comment", mappedBy="product", orphanRemoval=true)
     */
    private $comments;
